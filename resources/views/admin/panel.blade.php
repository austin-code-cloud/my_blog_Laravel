                                        ...
                                        <div class="card-body px-0 pt-2">
                                            <div class="table-responsive px-3" data-simplebar style="max-height: 393px;">
                                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 20px;"><img src="{{asset('panel/assets/images/users/avatar-4.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('panel/assets/images/users/avatar-5.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('panel/assets/images/users/avatar-6.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('panel/assets/images/users/avatar-7.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('panel/assets/images/users/avatar-8.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('panel/assets/images/users/avatar-2.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                                <h6 class="font-size-15 mb-1">Marie Kim</h6>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('panel/assets/images/users/avatar-1.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                            <td>
                                                                <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="{{asset('panel/assets/images/flags/us.jpg')}}" alt="user-image" class="me-3" height="18">US</td>
                                                    <td>
                                                        26,568.84
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('panel/assets/images/flags/germany.jpg')}}" alt="user-image" class="me-3" height="18">German</td>
                                                    <td>
                                                        36,485.52
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('panel/assets/images/flags/italy.jpg')}}" alt="user-image" class="me-3" height="18">Italy</td>
                                                    <td>
                                                        17,568.84
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('panel/assets/images/flags/spain.jpg')}}" alt="user-image" class="me-3" height="18">Spain</td>
                                                    <td>
                                                        75,521.28
                                                    </td>
                                                    <td>
